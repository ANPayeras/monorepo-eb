...
const TransferencePm = ({ reference }: { reference: string }) => {
    return (
        <div className='flex flex-col gap-2 text-sm xs:text-medium text-center'>
            <span>Enviá una transferencia al siguiente CBU:</span>
            ...
            <div className='flex justify-center items-center gap-2'>
                <span className='font-bold'>oficial.estoy.link@gmail.com</span>
                <CopyLink text='oficial.estoy.link@gmail.com' />
            </div>
