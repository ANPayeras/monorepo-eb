        ...
        >
            ...
            <div className="flex gap-2 md:gap-0 md:flex-col">
                ...
                <div className="text-lg font-bold mb-2 relative z-10 pl-0 pr-10 md:px-10">
                    <div className="absolute -left-[70px] md:left-0 top-1/2 -translate-x-1/2 md:top-auto md:translate-x-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-neutral-300 dark:bg-neutral-700 group-hover/feature:bg-slate-900 transition-all duration-200 origin-center" />
