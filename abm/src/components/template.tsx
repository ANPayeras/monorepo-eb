...
const Template = ({ template, user }: { template: Doc<"templates">, user: UserResource }) => {
    ...
    return (
        <div className='flex flex-col py-10 gap-10 items-center overflow-y-scroll rounded-sm min-w-[300px] max-w-[400px] min-h-[80vh] max-h-[80vh] sm:min-h-0 sm:max-h-full h-[95%]'
            style={{
