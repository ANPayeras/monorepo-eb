...
const PaymentMethodsPreview: FC<PaymentMethodsProps> = ({ selectSection, editSection, paymentMethods, containerClassName }) => {
    return (
        <div className={cn('w-full flex flex-col space-y-1 border p-2 rounded-sm border-slate-900', containerClassName)}>
