...
const ContactInfo: FC<{ selectSection?: (type: string) => void, editSection?: SelectSection, contact: Contact[], layout: Layout, props?: any }> = ({ selectSection, editSection, contact, layout, props }) => {
    return (
        <>
            <div className='flex justify-between items-center w-full p-2' {...props}>
